import{D as G,R as Ie,jt as VP,mn as de,tn as _i,ut as QI,y as E,z as Ir}from"./chunk-DYEHaq22.js";var i=new WeakMap;var h=(()=>{class e{_appRef;_injector=E(Ie);_environmentInjector=E(de);load(t){let n=this._appRef=this._appRef||this._injector.get(_i),o=i.get(n);o||(o={loaders:new Set,refs:[]},i.set(n,o),n.onDestroy(()=>{i.get(n)?.refs.forEach(y=>y.destroy()),i.delete(n)})),o.loaders.has(t)||(o.loaders.add(t),o.refs.push(VP(t,{environmentInjector:this._environmentInjector})))}static ɵfac=function(n){return new(n||e)};static ɵprov=Ir({token:e,factory:e.ɵfac})}return e})();var j=(()=>{class e{static ɵfac=function(n){return new(n||e)};static ɵcmp=QI({type:e,selectors:[[`ng-component`]],exportAs:[`cdkVisuallyHidden`],decls:0,vars:0,template:function(n,o){},styles:[`.cdk-visually-hidden {
  border: 0;
  clip: rect(0 0 0 0);
  height: 1px;
  margin: -1px;
