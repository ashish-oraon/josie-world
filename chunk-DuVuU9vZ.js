...
`],encapsulation:2})}return n})();var An=(()=>{class n{static ɵfac=function(i){return new(i||n)};static ɵmod=YI({type:n});static ɵinj=Ul({imports:[Pi$1,pr,ne$1]})}return n})();var us=(()=>{class n{static ɵfac=function(i){return new(i||n)};static ɵcmp=QI({type:n,selectors:[[`ng-component`]],hostAttrs:[`cdk-text-field-style-loader`,``],decls:0,vars:0,template:function(i,r){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
